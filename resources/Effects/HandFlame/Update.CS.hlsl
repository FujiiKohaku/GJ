...
void main(uint32_t3 DTid : SV_DispatchThreadID)
{
    ...
    // 炎の温度によるグラデーション変化
    float4 currentColor;
    float4 coreColor  = { 1.0f, 1.0f, 0.8f, 1.0f }; // 燃え始め（中心の白黄）
    float4 flameColor = { 1.0f, 0.4f, 0.0f, 1.0f }; // メラメラするオレンジ
    float4 smokeColor = { 0.6f, 0.0f, 0.0f, 0.0f }; // 消滅（赤から透明）
